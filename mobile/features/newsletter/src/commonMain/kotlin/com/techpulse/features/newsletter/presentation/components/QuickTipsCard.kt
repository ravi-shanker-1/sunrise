...
private val QuickTipsColor = Color(0xFF43A047)
...
fun QuickTipsCard(
    ...
    Card(
        ...
        colors = CardDefaults.cardColors(
            containerColor = QuickTipsColor.copy(alpha = 0.08f)
        ),
        ...
        Row(
            ...
            IconButton(onClick = onBookmarkToggle, modifier = Modifier.size(28.dp)) {
                Icon(
                    ...
                    tint = if (item.isBookmarked) QuickTipsColor else MaterialTheme.colorScheme.onSurfaceVariant,
